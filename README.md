...
- Firebase Push Notifications
  - [Setting up and firebase](https://css-tricks.com/implementing-push-notifications-setting-firebase/)
  - [The Back End](https://css-tricks.com/implementing-push-notifications-back-end/)
- [Angular Cheat Sheet](https://angular.io/guide/cheatsheet)
- [Learn RxJS](https://www.learnrxjs.io/)
- [Fundamentals of Redux](https://egghead.io/courses/getting-started-with-redux)
- [Building Idiomatic Redux](https://egghead.io/courses/building-react-applications-with-idiomatic-redux)
- [Learn Git Branching](https://learngitbranching.js.org/)
- [ES6 training](http://ES6.io)

## Web Assembly/Rust

- [Web Assembly Online Compiler Demonstration](https://mbebenita.github.io/WasmExplorer/)
- [Mozila web assembly editor](https://webassembly.studio/)
- [Rust with webassembly](https://www.hellorust.com/)
